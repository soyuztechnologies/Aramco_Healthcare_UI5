sap.ui.define([
    ...
    'emc2/sd/products/util/formatter'
    ...
    return BaseController.extend("emc2.sd.products.controller.View1",{
        ...
        onNext: function(sPath){
            //Extract the Unique ID of the fruit which was selected - /fruits/3
            ...
            // var oV2 = this.getView().getParent().getPage("idView2");
            // Bind the V2 with the path
